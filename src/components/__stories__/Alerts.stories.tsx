    ...
    <div className="flex items-center justify-center py-12">
      ...
      >
        <div className="flex flex-col gap-4 px-5">
          ...
          <p className="lyra-body-md text-lyra-fg-default">
            Clearly describe what will happen if they proceed, and always offer a safe way to exit the process without making changes.
          </p>
        </div>
...
export const ModalDestructive: Story = {
    ...
    <div className="flex items-center justify-center py-12">
      ...
      >
        <div className="flex flex-col gap-2 px-5">
          <p className="lyra-body-md text-lyra-fg-default">
            Use a warning modal with a red button for:
          </p>
          <ul className="list-disc pl-5 lyra-body-md text-lyra-fg-default">
            <li>Destructive actions that are difficult to recreate.</li>
            <li>Irreversible actions with high impact on the system.</li>
          </ul>
        </div>
        <div className="flex justify-end gap-2 px-5 pb-5 mt-6">
          <Button variant="outline" size="sm">Button</Button>
  ...
  render: () => (
    <div className="flex items-center justify-center py-12">
      ...
      >
        <div className="flex flex-col gap-2 px-5">
          <p className="lyra-body-md text-lyra-fg-default">
            Use error modals for:
          </p>
          <ul className="list-disc pl-5 lyra-body-md text-lyra-fg-default">
            <li>Failures: Important actions that failed and require explicit acknowledgment.</li>
            <li>Required Decisions: Errors that force a user to choose a path to move forward.</li>
          </ul>
        </div>
        <div className="flex justify-end gap-2 px-5 pb-5 mt-6">
          <Button variant="outline" size="sm">Button</Button>
      ...
      >
        <div className="flex flex-col gap-4 px-5">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <Checkbox />
            <span className="lyra-body-md text-lyra-fg-default">I understand and agree</span>
          </label>
        </div>
        <div className="flex justify-end gap-2 px-5 pb-5 mt-6">
          <Button variant="outline" size="sm">Button</Button>
  ...
  render: () => (
    <div className="flex items-center justify-center py-12">
      ...
      >
        <div className="flex flex-col gap-2 px-5">
          <p className="lyra-body-md text-lyra-fg-default">
            Try to avoid success modals.
          </p>
          <p className="lyra-body-md text-lyra-fg-default">
            Use only for:
          </p>
          <ul className="list-disc pl-5 lyra-body-md text-lyra-fg-default">
            <li>Next Steps: The user must choose their next action to proceed.</li>
            <li>Critical Output: The task generates a report, receipt, or data the user must see immediately.</li>
            <li>Major Milestones: Announcing a significant step completion.</li>
          </ul>
        </div>
        <div className="flex justify-end gap-2 px-5 pb-5 mt-6">
          <Button variant="outline" size="sm">Button</Button>
