import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-DhMLlvMY.js";import{a as re}from"./index-3Mvvhvj2.js";import{P as U}from"./index-0SMGJ9Xv.js";import{c as J}from"./index-1evVQkiP.js";import{c as S}from"./utils-BLSKlp9E.js";import{L as K}from"./label-DV0nvecx.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-2UU9FgV2.js";import"./index-D7lG0nq1.js";import"./tooltip-B7WaxDQZ.js";import"./circle-help-DYnzmdO5.js";import"./createLucideIcon-aII_sYFw.js";var se=Object.defineProperty,i=(a,r)=>se(a,"name",{value:r,configurable:!0}),Q="Progress",L=100,[le,Ie]=re(Q),[te,ne]=le(Q),oe=u.forwardRef(i(function(r,n){const{__scopeProgress:c,value:t=null,max:l,getValueLabel:y=Y,...w}=r;(l||l===0)&&!N(l)&&console.error(Z(`${l}`,"Progress"));const o=N(l)?l:L;t!==null&&!P(t,o)&&console.error(ee(`${t}`,"Progress"));const d=P(t,o)?t:null,ae=m(d)?y(d,o):void 0;return e.jsx(te,{scope:c,value:d,max:o,children:e.jsx(U.div,{"aria-valuemax":o,"aria-valuemin":0,"aria-valuenow":m(d)?d:void 0,"aria-valuetext":ae,role:"progressbar","data-state":j(d,o),"data-value":d??void 0,"data-max":o,...w,ref:n})})},"Progress")),ie="ProgressIndicator",ce=u.forwardRef(i(function(r,n){const{__scopeProgress:c,...t}=r,l=ne(ie,c);return e.jsx(U.div,{"data-state":j(l.value,l.max),"data-value":l.value??void 0,"data-max":l.max,...t,ref:n})},"ProgressIndicator"));function Y(a,r){return`${Math.round(a/r*100)}%`}i(Y,"defaultGetValueLabel");function j(a,r){return a==null?"indeterminate":a===r?"complete":"loading"}i(j,"getProgressState");function m(a){return typeof a=="number"}i(m,"isNumber");function N(a){return m(a)&&!isNaN(a)&&a>0}i(N,"isValidMaxNumber");function P(a,r){return m(a)&&!isNaN(a)&&a<=r&&a>=0}i(P,"isValidValueNumber");function Z(a,r){return`Invalid prop \`max\` of value \`${a}\` supplied to \`${r}\`. Only numbers greater than 0 are valid max values. Defaulting to \`${L}\`.`}i(Z,"getInvalidMaxError");function ee(a,r){return`Invalid prop \`value\` of value \`${a}\` supplied to \`${r}\`. The \`value\` prop must be:
  - a positive number
  - less than the value passed to \`max\` (or ${L} if no \`max\` prop is set)
  - \`null\` or \`undefined\` if the progress is indeterminate.

Defaulting to \`null\`.`}i(ee,"getInvalidValueError");var de=oe,ue=ce;const me=J("relative w-full overflow-hidden rounded-full bg-lyra-border-subtle",{variants:{size:{sm:"h-1",md:"h-2",lg:"h-3"}},defaultVariants:{size:"md"}}),fe=J("h-full w-full flex-1 rounded-full transition-all duration-300 ease-in-out",{variants:{variant:{default:"bg-lyra-bg-active-strong",success:"bg-lyra-status-success-strong",warning:"bg-lyra-status-warning-strong",critical:"bg-lyra-status-critical-strong",neutral:"bg-lyra-fg-secondary"}},defaultVariants:{variant:"default"}}),s=u.forwardRef(({className:a,value:r=0,size:n,variant:c,showLabel:t,label:l,indicatorClassName:y,...w},o)=>e.jsxs("div",{className:"flex flex-col gap-1 w-full",children:[e.jsx(de,{ref:o,value:r,max:100,className:S(me({size:n}),"w-full",a),...w,children:e.jsx(ue,{className:S(fe({variant:c}),y),style:{transform:`translateX(-${100-Math.min(100,Math.max(0,r))}%)`}})}),t&&e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary tabular-nums",children:l??`${Math.round(r)}%`})]}));s.displayName="ProgressBar";s.__docgenInfo={description:"",methods:[],displayName:"ProgressBar",props:{value:{required:!1,tsType:{name:"number"},description:"0–100",defaultValue:{value:"0",computed:!1}},showLabel:{required:!1,tsType:{name:"boolean"},description:"Show percentage label to the right of the track"},label:{required:!1,tsType:{name:"string"},description:'Override the label text (defaults to "{value}%")'},indicatorClassName:{required:!1,tsType:{name:"string"},description:'Escape hatch to override the indicator\'s transition (default\n`transition-all duration-300 ease-in-out`, from `indicatorVariants`) for\na specific usage — e.g. matching a particular reference animation curve\n— without changing the default for every other consumer. Merged in via\n`cn()`/tailwind-merge, so e.g. `"duration-[330ms] ease-[cubic-bezier(0.65,0,0.35,1)]"`\ncorrectly overrides just those two utility groups. See\n`ProgressBar.stories.tsx`\'s "Animated — Dashboard Loading" story for a\nreal usage (matching Radix\'s own Progress primitive docs easing curve).'}},composes:["VariantProps"]};const ze={title:"Headless Primitives/Progress Bar",component:s,tags:["autodocs"],parameters:{layout:"padded",backgrounds:{default:"lyra-shell"}},argTypes:{value:{control:{type:"range",min:0,max:100,step:1}},variant:{control:"select",options:["default","success","warning","critical","neutral"]},size:{control:"select",options:["sm","md","lg"]},showLabel:{control:"boolean"}}},f={args:{value:60,variant:"default",size:"md",showLabel:!0}},pe={default:"Default",success:"Success",warning:"Warning",critical:"Critical",neutral:"Neutral"},p={name:"All Variants",render:()=>e.jsx("div",{className:"flex flex-col gap-5 w-full max-w-md",children:["default","success","warning","critical","neutral"].map(a=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx(K,{label:pe[a],className:"text-lyra-fg-secondary"}),e.jsx(s,{value:65,variant:a,showLabel:!0})]},a))})},v={name:"Sizes",render:()=>e.jsx("div",{className:"flex flex-col gap-5 w-full max-w-md",children:["sm","md","lg"].map(a=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:a}),e.jsx(s,{value:70,size:a})]},a))})},g={name:"States",render:()=>e.jsxs("div",{className:"flex flex-col gap-5 w-full max-w-md",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"Empty (0%)"}),e.jsx(s,{value:0,showLabel:!0})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"In progress (45%)"}),e.jsx(s,{value:45,showLabel:!0})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"Complete (100%)"}),e.jsx(s,{value:100,variant:"success",showLabel:!0})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"Warning threshold (80%)"}),e.jsx(s,{value:80,variant:"warning",showLabel:!0})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"Critical (95%)"}),e.jsx(s,{value:95,variant:"critical",showLabel:!0})]})]})},x={name:"Animated",render:()=>{const[a,r]=u.useState(0);u.useEffect(()=>{const c=setInterval(()=>{r(t=>t>=100?(clearInterval(c),100):t+2)},80);return()=>clearInterval(c)},[]);const n=a>=100?"success":a>=80?"warning":"default";return e.jsxs("div",{className:"flex flex-col gap-2 w-full max-w-md",children:[e.jsx("span",{className:"lyra-label text-lyra-fg-secondary",children:"Loading…"}),e.jsx(s,{value:a,variant:n,size:"md",showLabel:!0})]})}},b={name:"Animated With Label",render:()=>{const[a,r]=u.useState(0);return u.useEffect(()=>{const n=setTimeout(()=>r(60),100);return()=>clearTimeout(n)},[]),e.jsxs("div",{className:"flex flex-col gap-2 w-full max-w-md",children:[e.jsx(K,{label:"Agent Skill Level"}),e.jsx(s,{value:a,variant:"default",size:"md",indicatorClassName:"duration-[330ms] ease-[cubic-bezier(0.65,0,0.35,1)]"})]})}},h={name:"Custom Label",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-full max-w-md",children:[e.jsx(s,{value:30,showLabel:!0,label:"3 / 10 steps"}),e.jsx(s,{value:48,showLabel:!0,label:"2,400 / 5,000 calls"})]})};var V,I,z;f.parameters={...f.parameters,docs:{...(V=f.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    value: 60,
    variant: "default",
    size: "md",
...
}`,...(B=(E=p.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var C,_,M;v.parameters={...v.parameters,docs:{...(C=v.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: "Sizes",
  render: () => <div className="flex flex-col gap-5 w-full max-w-md">
...
}`,...(M=(_=v.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};var T,$,R;g.parameters={...g.parameters,docs:{...(T=g.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "States",
  render: () => <div className="flex flex-col gap-5 w-full max-w-md">
...
}`,...(R=($=g.parameters)==null?void 0:$.docs)==null?void 0:R.source}}};var D,k,W;x.parameters={...x.parameters,docs:{...(D=x.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "Animated",
  render: () => {
...
}`,...(H=(F=h.parameters)==null?void 0:F.docs)==null?void 0:H.source}}};const Ae=["Default","Variants","Sizes","States","Animated","AnimatedWithLabel","CustomLabel"];export{x as Animated,b as AnimatedWithLabel,h as CustomLabel,f as Default,v as Sizes,g as States,p as Variants,Ae as __namedExportsOrder,ze as default};
