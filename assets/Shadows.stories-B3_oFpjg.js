    ...
    return <div className="space-y-12 max-w-[1200px]">
        ...
        <div>
          ...
          <div className="flex items-center gap-lyra-4 p-lyra-8 bg-lyra-bg-surface-shell rounded-lyra-lg">
            ...
            <div className="inline-flex items-center justify-center h-9 px-4 bg-lyra-bg-control text-lyra-fg-default border border-lyra-border-default rounded-lyra-sm lyra-label" style={{
            boxShadow: shadows.xs
          }}>
              Outline + shadow-xs
            </div>
