import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-CXOcBcs0.js";import{T as a}from"./toggle-group-CR6p76tC.js";import{c as m}from"./utils-BLSKlp9E.js";import"./_commonjsHelpers-CqkleIqs.js";const k={title:"Custom Primitives/Toggle Group",component:a,tags:["autodocs"],parameters:{layout:"centered",backgrounds:{default:"lyra-shell"}}},c=[{value:"a",label:"Toggle"},{value:"b",label:"Toggle"},{value:"c",label:"Toggle"}],s={render:()=>{const[l,r]=u.useState("a");return e.jsx(a,{items:c,value:l,onValueChange:r})}},t={name:"Full Width",parameters:{layout:"padded"},render:()=>{const[l,r]=u.useState("main");return e.jsx("div",{className:"w-80 rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-base p-3",children:e.jsx(a,{fullWidth:!0,items:[{value:"main",label:"Alex Kowalski (CST-10000)"},{value:"panel",label:"Search"}],value:l,onValueChange:b=>b&&r(b)})})}},n={name:"Multiple Selection",render:()=>{const[l,r]=u.useState(["a"]);return e.jsx(a,{type:"multiple",items:c,values:l,onValuesChange:r})}},o={name:"All States",parameters:{layout:"padded"},render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-48",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Off"}),e.jsx(a,{items:[{value:"x",label:"Toggle"}]})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Disabled"}),e.jsx(a,{items:[{value:"x",label:"Toggle"}],disabled:!0})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Hover"}),e.jsx("div",{className:"inline-flex items-center rounded-lyra-md border border-lyra-border-subtle bg-lyra-bg-surface-base p-0.5",children:e.jsx("button",{type:"button",className:"px-4 py-1.5 lyra-body-md rounded-lyra-sm text-lyra-fg-default bg-lyra-bg-surface-shell border border-lyra-border-soft transition-colors",children:"Toggle"})})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Press"}),e.jsx("div",{className:"inline-flex items-center rounded-lyra-md border border-lyra-border-subtle bg-lyra-bg-surface-base p-0.5",children:e.jsx("button",{type:"button",className:"px-4 py-1.5 lyra-body-md rounded-lyra-sm text-lyra-fg-default bg-lyra-bg-disabled border border-lyra-border-soft transition-colors",children:"Toggle"})})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"On"}),e.jsx(a,{items:[{value:"x",label:"Toggle"}],value:"x",onValueChange:()=>{}})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Selected Hover"}),e.jsx("div",{className:"inline-flex items-center rounded-lyra-md border border-lyra-border-subtle bg-lyra-bg-surface-base p-0.5",children:e.jsx("button",{type:"button",className:m("px-4 py-1.5 lyra-body-md rounded-lyra-sm font-medium transition-colors","bg-lyra-state-hover-active-subtle border border-lyra-border-active text-lyra-fg-active-strong"),children:"Toggle"})})]}),e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Selected Press"}),e.jsx("div",{className:"inline-flex items-center rounded-lyra-md border border-lyra-border-subtle bg-lyra-bg-surface-base p-0.5",children:e.jsx("button",{type:"button",className:m("px-4 py-1.5 lyra-body-md rounded-lyra-sm font-medium transition-colors","bg-lyra-state-pressed-active-subtle border border-lyra-border-active text-lyra-fg-active-strong"),children:"Toggle"})})]})]})},d={name:"With Disabled Item",render:()=>{const[l,r]=u.useState("a");return e.jsx(a,{items:[{value:"a",label:"Toggle"},{value:"b",label:"Toggle",disabled:!0},{value:"c",label:"Toggle"}],value:l,onValueChange:r})}},i={name:"Fully Disabled",render:()=>e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx(a,{items:c,disabled:!0}),e.jsx(a,{items:c,value:"b",onValueChange:()=>{},disabled:!0})]})};var g,y,p;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
