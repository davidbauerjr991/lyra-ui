import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as a}from"./index-CXOcBcs0.js";import{D as d}from"./draggable-CBELq2q1.js";import{C as h}from"./container-header-Bfsb3MJm.js";import{P as E}from"./page-header-DhvxSvkZ.js";import{B as Y}from"./button-5FlDPGRL.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-BLSKlp9E.js";import"./tooltip-DsDWII6n.js";import"./index-DNfP5j1O.js";import"./index-DWcjTdiE.js";import"./index-DujEZ9g2.js";import"./createLucideIcon-DEcfmm_F.js";import"./panel-right-CgZ2ABSM.js";import"./x-N8aIqrq2.js";import"./chip-CgDre8Tq.js";import"./panel-left-CWVFPQ0g.js";import"./index-BDkVnVO1.js";import"./index-1evVQkiP.js";const ie={title:"Atoms/Draggable",component:d,tags:["autodocs"],parameters:{layout:"padded",backgrounds:{default:"lyra-shell"}}},f={name:"Float (default)",parameters:{layout:"fullscreen"},render:()=>e.jsx("div",{className:"relative w-full h-screen",children:e.jsx("div",{className:"absolute top-4 left-4",children:e.jsxs(d,{defaultWidth:300,defaultHeight:200,className:"rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-overlay shadow-lg",children:[e.jsx(h,{title:"Drag me by the header",bordered:!1}),e.jsx("div",{className:"flex-1 flex items-center justify-center",children:e.jsx("p",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Resize from the bottom-right corner"})})]})})})},u={name:"Docked (right side)",parameters:{layout:"fullscreen"},render:()=>e.jsxs("div",{className:"flex h-screen overflow-hidden bg-lyra-bg-surface-shell",children:[e.jsx("div",{className:"flex-1 flex items-center justify-center",children:e.jsx("p",{className:"lyra-body-md text-lyra-fg-secondary",children:"Main content — drag the left edge of the panel to resize"})}),e.jsx("div",{className:"h-full pr-3 pb-3",children:e.jsxs(d,{variant:"docked",defaultWidth:320,minWidth:280,lockVariant:!0,className:"rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-overlay",children:[e.jsx(h,{title:"Docked Panel",bordered:!1}),e.jsx("div",{className:"flex-1 flex items-center justify-center",children:e.jsx("p",{className:"lyra-body-sm text-lyra-fg-secondary",children:"Drag left edge to resize"})})]})})]})},m={name:"With main container",parameters:{layout:"fullscreen"},render:()=>{const[n,p]=a.useState(!0),[i,V]=a.useState(!0),[l,b]=a.useState("open"),[c,B]=a.useState("docked"),[s,M]=a.useState(320),[F,I]=a.useState(!1),r=a.useRef(null),o=a.useRef(null),y=a.useRef();a.useEffect(()=>{if(clearTimeout(y.current),n){if(r.current&&o.current===null){const t=r.current.getBoundingClientRect();o.current=t.left+r.current.offsetWidth-s-16}V(!0),b("open")}else b("closing"),y.current=setTimeout(()=>b("closed"),150);return()=>clearTimeout(y.current)},[n]);const L=t=>{if(t==="float"&&r.current){const v=r.current.getBoundingClientRect();o.current=v.left+r.current.offsetWidth-s-16}else o.current=null;B(t)},O=()=>{var N;const t=(N=r.current)==null?void 0:N.getBoundingClientRect(),v=o.current!==null?o.current:r.current?((t==null?void 0:t.left)??0)+r.current.offsetWidth-s-16:0;return{position:"fixed",top:(t==null?void 0:t.top)??0,left:v,zIndex:40}},x=i?e.jsxs(d,{variant:c,defaultWidth:s,defaultHeight:500,minWidth:280,minHeight:200,onVariantChange:L,onWidthChange:M,onResizeStateChange:I,className:["rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-overlay",c==="float"?"shadow-lg":"h-full"].join(" "),children:[e.jsx(h,{title:"Panel",bordered:!1}),e.jsx("div",{className:"flex-1"})]}):null;return e.jsxs("div",{className:"flex h-screen overflow-hidden bg-lyra-bg-surface-shell p-4",children:[e.jsxs("div",{ref:r,className:"relative flex flex-1 min-w-0 overflow-hidden",children:[e.jsx("div",{className:"flex flex-col flex-1 rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-base overflow-hidden",children:e.jsx(E,{title:"Page Title",actions:e.jsx(Y,{variant:"outline",onClick:()=>p(t=>!t),children:"Toggle right panel"})})}),c==="float"&&i&&e.jsx("div",{style:{...O(),pointerEvents:l==="closed"?"none":"auto",visibility:l==="closed"?"hidden":"visible",opacity:l==="open"?1:0,transform:l==="open"?"translateY(0)":"translateY(-8px)",transition:l==="open"?"opacity 150ms ease, transform 150ms ease":"opacity 100ms ease, transform 100ms ease"},children:x})]}),c==="docked"&&e.jsx("div",{style:{width:l==="open"?s+16:0,overflow:"hidden",flexShrink:0,transition:F?"none":"width 250ms cubic-bezier(0.4, 0, 0.2, 1)"},children:e.jsx("div",{className:"h-full pl-4",style:{width:s+16,display:l==="open"?"block":"none"},children:x})})]})}},g={name:"Interactive (toggle float ↔ docked)",parameters:{layout:"fullscreen"},render:()=>{const[n,p]=a.useState("float"),i=e.jsxs(d,{variant:n,defaultWidth:320,defaultHeight:420,minWidth:280,minHeight:200,onVariantChange:p,className:["rounded-lyra-lg border border-lyra-border-subtle bg-lyra-bg-surface-overlay",n==="float"?"shadow-lg":""].join(" "),children:[e.jsx(h,{title:"Panel",bordered:!1}),e.jsx("div",{className:"flex-1 flex items-center justify-center p-4",children:e.jsxs("p",{className:"lyra-body-sm text-lyra-fg-secondary text-center",children:["Currently ",e.jsx("strong",{children:n}),".",e.jsx("br",{}),"Use the icon in the top-right to toggle."]})})]});return e.jsxs("div",{className:"flex h-screen overflow-hidden bg-lyra-bg-surface-shell",children:[e.jsx("div",{className:"flex-1 flex items-center justify-center",children:e.jsx("p",{className:"lyra-body-md text-lyra-fg-secondary",children:"Main content area"})}),n==="docked"?e.jsx("div",{className:"h-full pr-3 pb-3",children:i}):e.jsx("div",{className:"absolute top-16 left-16",children:i})]})}};var j,S,w;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: "Float (default)",
  parameters: {
    layout: "fullscreen"
  },
...
}`,...(P=(D=m.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};var z,H,T;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
}`,...(T=(H=g.parameters)==null?void 0:H.docs)==null?void 0:T.source}}};const de=["Float","Docked","WithMainContainer","Interactive"];export{u as Docked,f as Float,g as Interactive,m as WithMainContainer,de as __namedExportsOrder,ie as default};
