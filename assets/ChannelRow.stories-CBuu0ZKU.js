import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as me}from"./index-CXOcBcs0.js";import{a as g,E as S,S as he,W as y,V as T,b as r}from"./channel-row-Bce_7t6l.js";import{T as x}from"./tabs-D092Waft.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-BLSKlp9E.js";import"./tag-DxwG2peS.js";import"./index-1evVQkiP.js";import"./tooltip-ughTrHl0.js";import"./index-DNfP5j1O.js";import"./index-DWcjTdiE.js";import"./index-DujEZ9g2.js";import"./floating-ui.react-dom-B7A2Lg_k.js";import"./x-N8aIqrq2.js";import"./createLucideIcon-DEcfmm_F.js";import"./kebab-menu-button-BDzzvji6.js";import"./menu-radix-D2E6cDL6.js";import"./index-DUC4V_Df.js";import"./Combination-CgjdYmp6.js";import"./tslib.es6-Ytcc2UEA.js";import"./scroll-chevron-CJM7PgJi.js";import"./chevron-up-DaHnz2kU.js";import"./chevron-down-BRCsRsv-.js";import"./chevron-right-DZKRY3zX.js";import"./ellipsis-vertical-CZvSBcNM.js";import"./phone-Di4N1bEU.js";import"./message-square-BpbTPZlK.js";import"./mail-CGsQAUqz.js";import"./clock-xCVatdV-.js";import"./triangle-alert-Btkn3DL5.js";import"./circle-check-Bqo3g0Bw.js";import"./user-rDz6zf5M.js";import"./menu-Cb0mW4XG.js";import"./chevron-left-C6DiQdwt.js";function a({children:s}){return e.jsx("div",{className:"w-[360px] overflow-hidden rounded-lyra-sm border border-lyra-border-subtle bg-lyra-bg-surface-base",children:s})}const qe={title:"UI/ChannelRow",parameters:{backgrounds:{default:"lyra-shell"},layout:"padded"},tags:["autodocs"]},t={render:()=>e.jsx(a,{children:e.jsx(g,{elapsed:"08:27",preview:"Chat_General",isFirst:!0})})},o={render:()=>e.jsx(a,{children:e.jsx(S,{elapsed:"Now",preview:"CXi SME Email",isFirst:!0})})},i={name:"SMS",render:()=>e.jsx(a,{children:e.jsx(he,{elapsed:"Now",preview:"CXoneSMS_1-833-457-2672",isFirst:!0})})},d={render:()=>e.jsx(a,{children:e.jsx(y,{elapsed:"Now",preview:"CXoneSMS_1-833-457-2672",isFirst:!0})})},l={render:()=>e.jsx(a,{children:e.jsx(T,{elapsed:"01:12",preview:"Chat_General",isFirst:!0})})},c={name:"Chat — Awaiting Response (red chip + red time)",render:()=>e.jsx(a,{children:e.jsx(g,{elapsed:"08:27",preview:"Chat_General",awaitingResponse:!0,isFirst:!0})})},p={name:"WhatsApp — Highlighted (current + active card)",render:()=>e.jsx(a,{children:e.jsx(y,{elapsed:"Now",preview:"CXoneSMS_1-833-457-2672",highlighted:!0,isFirst:!0})})},m={name:"Email — No Kebab Menu (removable=false)",render:()=>e.jsx(a,{children:e.jsx(S,{elapsed:"Now",preview:"CXi SME Email",removable:!1,isFirst:!0})})},h={name:"Voice — Different Default Menu (Listen/Download Recording)",render:()=>e.jsxs("div",{className:"flex flex-col gap-6",children:[e.jsx("div",{children:e.jsx("p",{className:"lyra-body-sm text-lyra-fg-secondary mb-2",children:"Chat/Email/SMS/WhatsApp share one default kebab menu (Send/Download Transcript, Translate Messages). Voice swaps those for recording-appropriate actions instead — open each kebab to compare."})}),e.jsx(a,{children:e.jsx(g,{elapsed:"08:27",preview:"Chat_General",isFirst:!0})}),e.jsx(a,{children:e.jsx(T,{elapsed:"01:12",preview:"Chat_General",isFirst:!0})})]})},u={name:"ChannelTab — Bar (SMS icon + label + address, kebab)",render:()=>{const[s,n]=me.useState("sms:1");return e.jsxs(x,{children:[e.jsx(r,{type:"sms",address:"(456) 383-3329",messageCount:16,interactionId:"707535188548",active:s==="sms:1",onClick:()=>n("sms:1")}),e.jsx(r,{type:"sms",address:"(456) 555-9981",messageCount:4,interactionId:"707535188611",active:s==="sms:2",onClick:()=>n("sms:2")})]})}},C={name:"ChannelTab — No Address (redialed voice call)",render:()=>e.jsx(x,{children:e.jsx(r,{type:"voice",interactionId:"707535188720",active:!0,onClick:()=>{}})})},w={name:"ChannelTab — New Outbound (0 messages)",render:()=>e.jsx(x,{children:e.jsx(r,{type:"whatsapp",address:"@Jamie Torres",messageCount:0,interactionId:"707535188799",active:!0,onClick:()=>{}})})},b={name:"ChannelTab — Responsive Collapse (narrow container)",render:()=>{const[s,n]=me.useState("sms:1");return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("p",{className:"lyra-body-sm text-lyra-fg-secondary",children:`Drag the dashed box's right edge narrower — each tab sheds its address first (≤480px), then its type label too (≤320px), down to icon + kebab only. Hover any tab at any width — its Tooltip always shows the full "Label address" plus message count/conversation id.`}),e.jsx("div",{className:"w-[420px] resize-x overflow-auto border border-dashed border-lyra-border-subtle p-2",children:e.jsxs(x,{className:"lyra-channel-tab-list-wrap",children:[e.jsx(r,{type:"sms",address:"(456) 383-3329",messageCount:16,interactionId:"707535188548",active:s==="sms:1",onClick:()=>n("sms:1")}),e.jsx(r,{type:"whatsapp",address:"@Jamie Torres",messageCount:4,interactionId:"707535188611",active:s==="sms:2",onClick:()=>n("sms:2")})]})})]})}},v={name:"All Types — Stacked in One Card",render:()=>e.jsxs(a,{children:[e.jsx(g,{elapsed:"08:00",preview:"Chat_General",awaitingResponse:!0,isFirst:!0}),e.jsx(S,{elapsed:"Now",preview:"CXi SME Email"}),e.jsx(he,{elapsed:"Now",preview:"CXoneSMS_1-833-457-2672"}),e.jsx(y,{elapsed:"Now",preview:"CXoneSMS_1-833-457-2672",highlighted:!0}),e.jsx(T,{elapsed:"01:12",preview:"Chat_General"})]})};var f,F,j;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => <Frame>
      <ChatChannelRow elapsed="08:27" preview="Chat_General" isFirst />
    </Frame>
}`,...(j=(F=t.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var N,R,M;o.parameters={...o.parameters,docs:{...(N=o.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => <Frame>
      <EmailChannelRow elapsed="Now" preview="CXi SME Email" isFirst />
    </Frame>
}`,...(M=(R=o.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var A,k,E;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "SMS",
  render: () => <Frame>
      <SmsChannelRow elapsed="Now" preview="CXoneSMS_1-833-457-2672" isFirst />
    </Frame>
}`,...(E=(k=i.parameters)==null?void 0:k.docs)==null?void 0:E.source}}};var _,X,D;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => <Frame>
      <WhatsAppChannelRow elapsed="Now" preview="CXoneSMS_1-833-457-2672" isFirst />
    </Frame>
}`,...(D=(X=d.parameters)==null?void 0:X.docs)==null?void 0:D.source}}};var G,I,L;l.parameters={...l.parameters,docs:{...(G=l.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <Frame>
      <VoiceChannelRow elapsed="01:12" preview="Chat_General" isFirst />
    </Frame>
}`,...(L=(I=l.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};var V,W,O;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(te=(ne=w.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var oe,ie,de;b.parameters={...b.parameters,docs:{...(oe=b.parameters)==null?void 0:oe.docs,source:{originalSource:`{
...
}`,...(de=(ie=b.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};var le,ce,pe;v.parameters={...v.parameters,docs:{...(le=v.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(pe=(ce=v.parameters)==null?void 0:ce.docs)==null?void 0:pe.source}}};const Pe=["Chat","Email","Sms","WhatsApp","Voice","AwaitingResponse","Highlighted","NoKebabMenu","VoiceMenuDiffersFromDigital","ChannelTabBar","ChannelTabNoAddress","ChannelTabNewOutbound","ChannelTabResponsive","AllTypesStacked"];export{v as AllTypesStacked,c as AwaitingResponse,u as ChannelTabBar,w as ChannelTabNewOutbound,C as ChannelTabNoAddress,b as ChannelTabResponsive,t as Chat,o as Email,p as Highlighted,m as NoKebabMenu,i as Sms,l as Voice,h as VoiceMenuDiffersFromDigital,d as WhatsApp,Pe as __namedExportsOrder,qe as default};
