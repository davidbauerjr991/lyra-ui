import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as pe}from"./index-CXOcBcs0.js";import{I as n}from"./input-CYoQVZ2d.js";import{L as a}from"./label-BSWV0633.js";import{A as B}from"./actions-BeTqZutj.js";import{B as H}from"./button-GxCpv2fL.js";import{S as ne}from"./separator-CVEAaEyG.js";import{S as be}from"./switch-DUKjEExm.js";import{E as xe}from"./error-icon-Jj0G9Pna.js";import{P as ae}from"./pencil-DdhzNlrF.js";import{S as se}from"./settings-Ddbozet5.js";import{C as fe}from"./copy-BRsdvqrt.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-BLSKlp9E.js";import"./index-DWcjTdiE.js";import"./index-DujEZ9g2.js";import"./tooltip-ughTrHl0.js";import"./index-DNfP5j1O.js";import"./floating-ui.react-dom-B7A2Lg_k.js";import"./circle-help-Bj2MpUE2.js";import"./createLucideIcon-DEcfmm_F.js";import"./chevron-down-BRCsRsv-.js";import"./index-BDkVnVO1.js";import"./index-1evVQkiP.js";import"./badge-go1ZjKcF.js";import"./index-CoT6TaLL.js";import"./check-DrRFj5bn.js";import"./minus-DYrWPnXn.js";const Ge={title:"Custom Primitives/Input",component:n,tags:["autodocs"],parameters:{layout:"padded",backgrounds:{default:"lyra-shell"}},argTypes:{required:{control:"boolean"},showLabelOnly:{control:"boolean",name:"Label only"},showWithButtons:{control:"boolean",name:"With buttons"},buttonsPosition:{control:"select",options:["left","right","both"],name:"Buttons position"},buttonVariant:{control:"select",options:["default","destructive","warning","success","outline","ghost"],name:"Button type"},buttonIconOnly:{control:"boolean",name:"Icon buttons"},buttonSize:{control:"select",options:["sm","default","lg","xl"],name:"Button size"},buttonCount:{control:"select",options:[1,2,3],name:"Button count"},showHelp:{control:"boolean",name:"Help"},showHorizontal:{control:"boolean",name:"Horizontal"},showError:{control:"boolean",name:"Error"},maxWidth:{control:"boolean",name:"Max width"}}},c={name:"Default",args:{label:"Input Label",placeholder:"Text",required:!1,showLabelOnly:!1,showWithButtons:!1,buttonsPosition:"left",buttonVariant:"ghost",buttonIconOnly:!0,buttonSize:"sm",buttonCount:2,showHelp:!1,showHorizontal:!1,showError:!1,maxWidth:!1},render:oe=>{const{showLabelOnly:w,showWithButtons:i,buttonsPosition:t,buttonVariant:N,buttonIconOnly:re,buttonSize:I,buttonCount:L,showHelp:le,showHorizontal:ie,showError:g,maxWidth:ce,required:o,label:r,...S}=oe,[ue,de]=pe.useState(!1),he={sm:"icon-sm",default:"icon-md",lg:"icon-lg",xl:"icon-xl"},me=[ae,se,fe],s=()=>re?e.jsx(e.Fragment,{children:me.slice(0,L).map((j,v)=>e.jsx(H,{variant:N,size:he[I],title:"Placeholder action",children:e.jsx(j,{className:"h-4 w-4",strokeWidth:1.5})},v))}):e.jsx(e.Fragment,{children:Array.from({length:L}).map((j,v)=>e.jsx(H,{variant:N,size:I,children:"Action"},v))}),l=le?"Helpful context about this field.":void 0,y=g&&e.jsxs("div",{className:"flex items-center gap-1 mt-1.5",children:[e.jsx(xe,{className:"h-3.5 w-3.5 flex-shrink-0","aria-hidden":"true"}),e.jsx("span",{className:"lyra-body-sm text-lyra-status-critical-strong",children:"Required"})]});return ie?e.jsxs("div",{className:"w-full",children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsx(a,{label:r,required:o,labelHelpText:l}),e.jsxs("div",{className:"flex items-center gap-0.5",children:[i&&(t==="left"||t==="both")&&s(),w?e.jsx("span",{className:"lyra-body-md text-lyra-fg-secondary",children:"Sarah Connor"}):e.jsx(be,{checked:ue,onCheckedChange:de}),i&&(t==="right"||t==="both")&&s()]})]}),y,e.jsx(ne,{className:"mt-3"})]}):w&&i?e.jsxs("div",{className:"w-72",children:[e.jsx(a,{label:r,required:o,labelHelpText:l}),e.jsxs("div",{className:"flex items-center gap-0.5",children:[(t==="left"||t==="both")&&s(),e.jsx("span",{className:"lyra-body-md text-lyra-fg-secondary",children:"Read-only value"}),(t==="right"||t==="both")&&s()]}),y]}):w?e.jsxs("div",{className:"w-72",children:[e.jsx(a,{label:r,supportingText:"Read-only value",required:o,labelHelpText:l}),y]}):i?e.jsxs("div",{className:"flex flex-col gap-1.5 w-72",children:[e.jsx(a,{label:r,required:o,labelHelpText:l}),e.jsxs("div",{className:"flex items-start gap-0.5",children:[(t==="left"||t==="both")&&s(),e.jsx(n,{...S,className:"w-48",error:g?"Required":void 0}),(t==="right"||t==="both")&&s()]})]}):e.jsx(n,{...S,label:r,required:o,labelHelpText:l,error:g?"Required":void 0,className:ce?"max-w-[320px]":void 0})}},u={name:"Filled",args:{label:"Input Label",defaultValue:"Text"}},d={name:"Disabled",args:{label:"Input Label",placeholder:"Text",disabled:!0}},h={name:"Readonly",args:{label:"Input Label",value:"Read-only value",readonly:!0}},m={name:"Label Only",render:()=>e.jsx("div",{className:"w-72",children:e.jsx(a,{label:"Input Label",supportingText:"Read-only value"})})},p={name:"Label With Buttons",render:()=>e.jsxs("div",{className:"flex flex-col gap-0 w-72",children:[e.jsx(a,{label:"Campaign State"}),e.jsxs("div",{className:"flex items-center gap-0.5",children:[e.jsx(B,{size:"sm",title:"Placeholder action",children:e.jsx(ae,{className:"h-4 w-4",strokeWidth:1.5})}),e.jsx(B,{size:"sm",title:"Placeholder action",children:e.jsx(se,{className:"h-4 w-4",strokeWidth:1.5})})]})]})},b={name:"Label Horizontal With Separator",render:()=>e.jsxs("div",{className:"flex flex-col gap-3 w-full",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(a,{label:"Agent Name"}),e.jsx("span",{className:"lyra-body-md text-lyra-fg-secondary",children:"Sarah Connor"})]}),e.jsx(ne,{})]})},x={name:"Error",args:{label:"Input Label",defaultValue:"Text",error:"Required"}},f={name:"All States",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 max-w-[400px]",children:[e.jsx(n,{label:"Input Label",placeholder:"Text"}),e.jsx(n,{label:"Input Label",defaultValue:"Text"}),e.jsx(n,{label:"Input Label",disabled:!0,placeholder:"Text"}),e.jsx(n,{label:"Input Label",defaultValue:"Text",error:"Required"})]})};var O,P,T;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "Default",
  args: {
    label: "Input Label",
    placeholder: "Text",
  ...
  render: (args: any) => {
    ...
    if (showWithButtons) {
      ...
      // "Required" twice.
      return <div className="flex flex-col gap-1.5 w-72">
          <Label label={label} required={required} labelHelpText={labelHelpText} />
          <div className="flex items-start gap-0.5">
            {(buttonsPosition === "left" || buttonsPosition === "both") && renderButtons()}
            <Input {...rest} className="w-48" error={showError ? "Required" : undefined} />
            {(buttonsPosition === "right" || buttonsPosition === "both") && renderButtons()}
          </div>
        </div>;
    }
    return <Input {...rest} label={label} required={required} labelHelpText={labelHelpText} error={showError ? "Required" : undefined} className={maxWidth ? "max-w-[320px]" : undefined} />;
  }
}`,...(T=(P=c.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var C,z,R;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: "Filled",
  args: {
    label: "Input Label",
    defaultValue: "Text"
  }
}`,...(R=(z=u.parameters)==null?void 0:z.docs)==null?void 0:R.source}}};var W,E,q;d.parameters={...d.parameters,docs:{...(W=d.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: "Disabled",
  args: {
    label: "Input Label",
    placeholder: "Text",
...
}`,...(q=(E=d.parameters)==null?void 0:E.docs)==null?void 0:q.source}}};var A,k,V;h.parameters={...h.parameters,docs:{...(A=h.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "Readonly",
  args: {
    label: "Input Label",
...
}`,...(V=(k=h.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var _,M,D;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: "Label Only",
  render: () => <div className="w-72">
      <Label label="Input Label" supportingText="Read-only value" />
    </div>
}`,...(D=(M=m.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};var F,Z,G;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(G=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:G.source}}};var J,K,Q;b.parameters={...b.parameters,docs:{...(J=b.parameters)==null?void 0:J.docs,source:{originalSource:`{
...
}`,...(Y=(X=x.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var $,ee,te;f.parameters={...f.parameters,docs:{...($=f.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "All States",
...
}`,...(te=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};const Je=["Default","Filled","Disabled","Readonly","LabelOnly","LabelWithButtons","LabelHorizontalWithSeparator","Error","AllStates"];export{f as AllStates,c as Default,d as Disabled,x as Error,u as Filled,b as LabelHorizontalWithSeparator,m as LabelOnly,p as LabelWithButtons,h as Readonly,Je as __namedExportsOrder,Ge as default};
