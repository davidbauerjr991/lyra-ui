import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./index-DhMLlvMY.js";import{c as d}from"./utils-BLSKlp9E.js";import{C as ve,a as ae,b as xe}from"./channel-row-B78teEyp.js";import{P as Ne}from"./popover-BCWMVAq6.js";import{B as j,g as ke}from"./badge-CJVmnMhy.js";import{B as V}from"./button-C7ty1faS.js";import{f as Te}from"./phone-input-switUA1g.js";import{C as Ce}from"./chevron-down-gMYAX9-q.js";import{U as Ae}from"./user-BnR-bf5w.js";import{C as Re}from"./circle-alert-DucVQP5w.js";import{T as je}from"./triangle-alert-C66Fwj6V.js";function Ee(i){const u=(i==null?void 0:i.trim().split(/\s+/).filter(Boolean))??[];return u.length===0?"C":u.length===1?u[0].charAt(0).toUpperCase():(u[0].charAt(0)+u[u.length-1].charAt(0)).toUpperCase()}function h(i){return i.id??i.type}const re=s.forwardRef(({customerName:i,customerIdentified:u,channels:r=[],elapsed:k,awaitingResponse:W=!1,awaitingSeverity:se,isNewAssignment:E=!1,active:o=!1,onHold:T=!1,expanded:oe=!1,onClick:p,onDismiss:K,onDismissChannel:D,headerAction:$,currentChannelKey:F,onCurrentChannelChange:f,collapsible:b=!1,channelsExpandedOverride:m,onChannelsExpandedChange:S,className:z},y)=>{const[l,q]=s.useState(!0);s.useEffect(()=>{S==null||S(l)},[l]);const H=s.useRef(m==null?void 0:m.version);m&&m.version!==H.current&&(H.current=m.version,l!==m.expanded&&q(m.expanded));const ie=Ee(i),U=Te(i)||"Customer",c=r.length,le=u??!!(i!=null&&i.trim()),O=s.useRef(null),ce=e=>{O.current=e,typeof y=="function"?y(e):y&&(y.current=e)},[Y,G]=s.useState(null),v=r.map(h),[I,de]=s.useState(v);if(v.length!==I.length||v.some((e,n)=>e!==I[n])){de(v);const e=v.find(n=>!I.includes(n));e!==void 0&&(G(e),f==null||f(e))}const X=[...r].reverse().find(e=>e.current)??r[r.length-1],he=X?h(X):void 0,ue=F!==void 0?F:r.some(e=>h(e)===Y)?Y:he,[J,_]=s.useState(!1),g=s.useRef(null),C=s.useRef(new Set),x=()=>{g.current&&(clearTimeout(g.current),g.current=null),_(!0)},N=()=>{g.current&&clearTimeout(g.current),!(C.current.size>0)&&(g.current=setTimeout(()=>_(!1),150))},Q=(e,n)=>{n?(C.current.add(e),x()):(C.current.delete(e),C.current.size===0&&N())};s.useEffect(()=>()=>{g.current&&clearTimeout(g.current)},[]);const a=W?se??"critical":null,Z=E?"critical":a==="critical"?null:a,P=T&&!o?{bg:"bg-lyra-status-warning-subtle",text:"text-lyra-status-warning-strong",border:"border-lyra-status-warning-strong"}:a==="critical"?{bg:"bg-lyra-status-critical-subtle",text:"text-lyra-status-critical-strong",border:o?"border-lyra-status-critical-strong":"border-lyra-status-critical-medium/30"}:a==="warning"?{bg:"bg-lyra-status-warning-subtle",text:"text-lyra-status-warning-strong",border:o?"border-lyra-status-warning-strong":"border-lyra-status-warning-strong/30"}:a==="success"?{bg:"bg-lyra-status-success-subtle",text:"text-lyra-status-success-strong",border:o?"border-lyra-status-success-strong":"border-lyra-status-success-strong/30"}:{bg:"bg-lyra-status-info-subtle",text:"text-lyra-status-info-strong",border:o?"border-lyra-status-info-strong":"border-lyra-status-info-medium/30"},pe=(e,n=()=>p==null?void 0:p())=>{e.target===e.currentTarget&&(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),n())},B=s.useRef(null),L=s.useRef(null),me=()=>{const e=B.current;return e?Array.from(e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')):[]},ge=e=>{var n;pe(e),e.key==="Tab"&&!e.shiftKey&&B.current&&(e.preventDefault(),(n=L.current)==null||n.focus())},fe=e=>{var n;e.key==="Tab"&&e.shiftKey&&(e.preventDefault(),(n=O.current)==null||n.focus())},we=e=>{var A;if(e.key!=="Tab"||e.shiftKey)return;const n=me(),w=n.length>0?n[n.length-1]:L.current;document.activeElement===w&&(e.preventDefault(),(A=O.current)==null||A.focus())},M=`${U}${E?", new assignment":""}${W?", awaiting response":""}${c>1?`, ${c} open channels`:""}${k?`, ${k}`:""}`,ee=r.map((e,n)=>{const w=o&&h(e)===ue,A=ve[e.type];return t.jsx(A,{elapsed:e.elapsed,elapsedOverride:e.elapsedOverride,onHoldElapsed:e.onHoldElapsed,preview:e.preview,highlighted:w,isFirst:n===0,awaitingResponse:e.awaitingResponse,awaitingSeverity:e.awaitingSeverity,removable:e.removable,removeVariant:e.removeVariant,menuItems:e.menuItems,showConsultTransfer:!1,showKebab:e.showKebab,alwaysShowOutcome:e.alwaysShowOutcome,showDismissButton:e.showDismissButton,onEndCall:e.onEndCall,controlsDisabled:e.controlsDisabled,direction:e.direction,onMenuOpenChange:R=>Q(h(e),R),onDismiss:()=>{r.length>1?D==null||D(e):K==null||K()},onSelect:()=>{G(h(e)),f==null||f(h(e))},outcome:e.outcome&&{...e.outcome,onOpenChange:R=>{Q(`outcome:${h(e)}`,R),e.outcome.onOpenChange(R)}}},`${h(e)}-${n}`)}),be=r.length>0&&t.jsx(V,{variant:"icon",size:"icon-sm",title:l?"Collapse channels":"Expand channels","aria-expanded":l,onClick:e=>{e.stopPropagation(),q(n=>!n)},children:t.jsx(Ce,{className:d("h-3.5 w-3.5 transition-transform duration-200",l&&"rotate-180"),strokeWidth:1.5,"aria-hidden":"true"})}),te=t.jsxs("div",{className:"relative z-[1] flex flex-col",children:[t.jsxs("div",{className:"flex items-center gap-2 px-3 pt-1 pb-1",children:[E&&t.jsx(j,{shape:"circle",dot:!0,variant:"critical",size:"sm",className:"shrink-0","aria-label":"New assignment"}),c>1&&t.jsx(j,{shape:"circle",size:"sm",count:c,className:"shrink-0","aria-label":`${c} open channels`}),b&&!l&&c===1&&r[0]&&t.jsx(j,{shape:"circle",size:"sm",className:"shrink-0",style:ke("subtle",xe[r[0].type]),"aria-label":`${ae[r[0].type].label} channel open`,children:s.cloneElement(ae[r[0].type].icon,{className:"h-2.5 w-2.5"})}),t.jsx("span",{className:"min-w-0 flex-1 truncate lyra-heading-sm text-lyra-fg-default",children:U}),(b||$)&&t.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[$,b&&be]})]}),r.length>0&&(b?t.jsx("div",{className:d("grid transition-[grid-template-rows] duration-200 ease-in-out",l?"grid-rows-[1fr]":"grid-rows-[0fr]"),children:t.jsx("div",{className:"overflow-hidden",children:t.jsx("div",{className:"flex flex-col",children:ee})})}):t.jsx("div",{className:"flex flex-col",children:ee}))]}),ne=d("relative flex w-full cursor-pointer flex-col overflow-hidden rounded-lyra-sm border-y border-r text-left transition-colors",T?"bg-lyra-status-warning-subtle":"bg-lyra-bg-surface-base",o?"border-l-4":"border-l",o&&"shadow-md",T?"border-lyra-status-warning-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-warning-strong)_80%,black_20%)]":o?a==="critical"?"border-lyra-status-critical-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-critical-strong)_80%,black_20%)]":a==="warning"?"border-lyra-status-warning-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-warning-strong)_80%,black_20%)]":a==="success"?"border-lyra-status-success-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-success-strong)_80%,black_20%)]":"border-lyra-border-active hover:border-[color-mix(in_srgb,var(--lyra-color-border-active)_80%,black_20%)]":"border-lyra-border-subtle hover:border-lyra-border-soft");if(!oe)return t.jsx(Ne,{open:J,onOpenChange:_,placement:"right",align:"start",sideOffset:8,showArrow:!1,onOpenAutoFocus:e=>e.preventDefault(),onCloseAutoFocus:e=>e.preventDefault(),onInteractOutside:e=>{var n,w;(w=(n=e.target)==null?void 0:n.closest)!=null&&w.call(n,"[data-radix-popper-content-wrapper]")&&e.preventDefault()},className:"z-[9999] w-64 rounded-lyra-sm border-0 bg-transparent p-0 shadow-none",bodyPadding:!1,content:t.jsxs("div",{onMouseEnter:x,onMouseLeave:N,onFocus:x,onBlur:N,onKeyDown:we,onClick:p,ref:B,className:d(ne,!o&&"shadow-md"),children:[t.jsx(V,{ref:L,variant:"ghost","aria-label":M,onKeyDown:fe,className:"absolute inset-0 h-full w-full p-0 hover:bg-transparent active:bg-transparent"}),te]}),children:t.jsxs("div",{ref:ce,role:"button",tabIndex:0,onClick:p,onKeyDown:ge,onMouseEnter:x,onMouseLeave:N,onFocus:x,onBlur:N,"aria-label":M,"aria-current":o?"true":void 0,className:d("flex cursor-pointer flex-col items-center gap-1 rounded-lyra-sm p-1.5 mb-2 transition-colors","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lyra-border-focus focus-visible:ring-offset-2",o?"bg-lyra-bg-surface-base shadow-sm":J&&"bg-lyra-state-hover",z),children:[t.jsxs("span",{className:"relative inline-flex",children:[t.jsx("span",{className:d("flex h-8 w-8 items-center justify-center rounded-lyra-sm border lyra-body-sm-emphasis",P.bg,P.text,P.border),"aria-hidden":"true",children:le?ie:t.jsx(Ae,{className:"h-4 w-4",strokeWidth:1.5})}),c>1&&t.jsx("span",{className:d("absolute -left-1.5 -top-1.5 flex h-[18px] items-center justify-center rounded-full font-bold text-lyra-fg-on-primary",a==="critical"||a==="warning"?"w-[18px]":"min-w-[18px] px-1 text-[10px]",a==="critical"?"bg-lyra-bg-destructive":a==="warning"?"bg-lyra-status-warning-strong":a==="success"?"bg-lyra-status-success-strong":"bg-lyra-bg-primary"),"aria-label":a==="critical"?"SLA breached":a==="warning"?"Nearing SLA breach":`${c} open channels`,children:a==="critical"?t.jsx(Re,{className:"h-2.5 w-2.5 shrink-0",strokeWidth:2.25,"aria-hidden":"true"}):a==="warning"?t.jsx(je,{className:"h-2.5 w-2.5 shrink-0",strokeWidth:2.25,"aria-hidden":"true"}):t.jsx("span",{"aria-hidden":"true",children:c})}),Z&&t.jsx(j,{shape:"circle",dot:!0,variant:Z,size:"sm",className:"absolute bottom-[-2px] right-[-2px] ring-2 ring-lyra-bg-surface-shell","aria-hidden":"true"})]}),k&&t.jsx("span",{className:d("lyra-body-xs",T||a==="critical"?"text-lyra-status-critical-strong":a==="warning"?"text-lyra-status-warning-strong":a==="success"?"text-lyra-status-success-strong":"text-lyra-fg-secondary"),"aria-hidden":"true",children:k})]})});const ye=()=>{b&&!l&&q(!0),p==null||p()};return t.jsxs("div",{ref:y,onClick:ye,className:d(ne,"mb-2",z),children:[t.jsx(V,{variant:"ghost","aria-label":M,"aria-current":o?"true":void 0,className:"absolute inset-0 h-full w-full p-0 hover:bg-transparent active:bg-transparent"}),te]})});re.displayName="InteractionNavItem";re.__docgenInfo={description:"",methods:[],displayName:"InteractionNavItem",props:{customerName:{required:!1,tsType:{name:"string"},description:`Customer's full name — OR, for an interaction with no matched
