import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./index-DhMLlvMY.js";import{c as d}from"./utils-BLSKlp9E.js";import{C as ge,a as te,b as fe}from"./channel-row-heTgqV4E.js";import{P as we}from"./popover-Di03N3uO.js";import{B,g as be}from"./badge-CSIGLv9X.js";import{B as ye}from"./button-C_xtDadR.js";import{f as ve}from"./phone-input-switUA1g.js";import{C as xe}from"./chevron-down-gMYAX9-q.js";import{U as ke}from"./user-BnR-bf5w.js";import{C as Ne}from"./circle-alert-DucVQP5w.js";import{T as Ce}from"./triangle-alert-C66Fwj6V.js";function Te(o){const h=(o==null?void 0:o.trim().split(/\s+/).filter(Boolean))??[];return h.length===0?"C":h.length===1?h[0].charAt(0).toUpperCase():(h[0].charAt(0)+h[h.length-1].charAt(0)).toUpperCase()}function u(o){return o.id??o.type}const ne=s.forwardRef(({customerName:o,customerIdentified:h,channels:r=[],elapsed:T,awaitingResponse:M=!1,awaitingSeverity:ae,active:i=!1,onHold:L=!1,expanded:re=!1,onClick:p,onDismiss:j,onDismissChannel:E,headerAction:W,currentChannelKey:V,onCurrentChannelChange:w,collapsible:v=!1,channelsExpandedOverride:m,onChannelsExpandedChange:I,className:$},x)=>{const[l,K]=s.useState(!0);s.useEffect(()=>{I==null||I(l)},[l]);const F=s.useRef(m==null?void 0:m.version);m&&m.version!==F.current&&(F.current=m.version,l!==m.expanded&&K(m.expanded));const se=Te(o),z=ve(o)||"Customer",c=r.length,oe=h??!!(o!=null&&o.trim()),O=s.useRef(null),ie=e=>{O.current=e,typeof x=="function"?x(e):x&&(x.current=e)},[H,U]=s.useState(null),k=r.map(u),[q,le]=s.useState(k);if(k.length!==q.length||k.some((e,n)=>e!==q[n])){le(k);const e=k.find(n=>!q.includes(n));e!==void 0&&(U(e),w==null||w(e))}const Y=[...r].reverse().find(e=>e.current)??r[r.length-1],ce=Y?u(Y):void 0,de=V!==void 0?V:r.some(e=>u(e)===H)?H:ce,[G,S]=s.useState(!1),g=s.useRef(null),A=s.useRef(new Set),N=()=>{g.current&&(clearTimeout(g.current),g.current=null),S(!0)},C=()=>{g.current&&clearTimeout(g.current),!(A.current.size>0)&&(g.current=setTimeout(()=>S(!1),150))},X=(e,n)=>{n?(A.current.add(e),N()):(A.current.delete(e),A.current.size===0&&C())};s.useEffect(()=>()=>{g.current&&clearTimeout(g.current)},[]);const a=M?ae??"critical":null,_=a==="critical"?{bg:"bg-lyra-status-critical-subtle",text:"text-lyra-status-critical-strong",border:i?"border-lyra-status-critical-strong":"border-lyra-status-critical-medium/30"}:a==="warning"?{bg:"bg-lyra-status-warning-subtle",text:"text-lyra-status-warning-strong",border:i?"border-lyra-status-warning-strong":"border-lyra-status-warning-strong/30"}:a==="success"?{bg:"bg-lyra-status-success-subtle",text:"text-lyra-status-success-strong",border:i?"border-lyra-status-success-strong":"border-lyra-status-success-strong/30"}:{bg:"bg-lyra-status-info-subtle",text:"text-lyra-status-info-strong",border:i?"border-lyra-status-info-strong":"border-lyra-status-info-medium/30"},D=(e,n=()=>p==null?void 0:p())=>{e.target===e.currentTarget&&(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),n())},b=s.useRef(null),ue=()=>{const e=b.current;return e?Array.from(e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')):[]},he=e=>{D(e),e.key==="Tab"&&!e.shiftKey&&b.current&&(e.preventDefault(),b.current.focus())},pe=e=>{var R,f;if(D(e),e.key!=="Tab")return;const n=ue();if(e.shiftKey){document.activeElement===b.current&&(e.preventDefault(),(R=O.current)==null||R.focus());return}const y=n.length>0?n[n.length-1]:b.current;document.activeElement===y&&(e.preventDefault(),(f=O.current)==null||f.focus())},P=`${z}${M?", awaiting response":""}${c>1?`, ${c} open channels`:""}${T?`, ${T}`:""}`,J=r.map((e,n)=>{const y=i&&u(e)===de,R=ge[e.type];return t.jsx(R,{elapsed:e.elapsed,elapsedOverride:e.elapsedOverride,preview:e.preview,highlighted:y,isFirst:n===0,awaitingResponse:e.awaitingResponse,awaitingSeverity:e.awaitingSeverity,removable:e.removable,removeVariant:e.removeVariant,menuItems:e.menuItems,showConsultTransfer:e.showConsultTransfer,showKebab:e.showKebab,alwaysShowOutcome:e.alwaysShowOutcome,showDismissButton:e.showDismissButton,onEndCall:e.onEndCall,direction:e.direction,onMenuOpenChange:f=>X(u(e),f),onDismiss:()=>{r.length>1?E==null||E(e):j==null||j()},onSelect:()=>{U(u(e)),w==null||w(u(e))},outcome:e.outcome&&{...e.outcome,onOpenChange:f=>{X(`outcome:${u(e)}`,f),e.outcome.onOpenChange(f)}}},`${u(e)}-${n}`)}),me=r.length>0&&t.jsx(ye,{variant:"icon",size:"icon-sm",title:l?"Collapse channels":"Expand channels","aria-expanded":l,onClick:e=>{e.stopPropagation(),K(n=>!n)},children:t.jsx(xe,{className:d("h-3.5 w-3.5 transition-transform duration-200",l&&"rotate-180"),strokeWidth:1.5,"aria-hidden":"true"})}),Q=t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"flex items-center gap-2 px-3 pt-1 pb-1",children:[c>1&&t.jsx(B,{shape:"circle",size:"sm",count:c,className:"shrink-0","aria-label":`${c} open channels`}),v&&!l&&c===1&&r[0]&&t.jsx(B,{shape:"circle",size:"sm",className:"shrink-0",style:be("subtle",fe[r[0].type]),"aria-label":`${te[r[0].type].label} channel open`,children:s.cloneElement(te[r[0].type].icon,{className:"h-2.5 w-2.5"})}),t.jsx("span",{className:"min-w-0 flex-1 truncate lyra-heading-sm text-lyra-fg-default",children:z}),(v||W)&&t.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[W,v&&me]})]}),r.length>0&&(v?t.jsx("div",{className:d("grid transition-[grid-template-rows] duration-200 ease-in-out",l?"grid-rows-[1fr]":"grid-rows-[0fr]"),children:t.jsx("div",{className:"overflow-hidden",children:t.jsx("div",{className:"flex flex-col",children:J})})}):t.jsx("div",{className:"flex flex-col",children:J}))]}),Z=d("flex w-full cursor-pointer flex-col overflow-hidden rounded-lyra-sm border-y border-r text-left transition-colors",L?"bg-lyra-status-warning-subtle":"bg-lyra-bg-surface-base","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lyra-border-focus focus-visible:ring-offset-2",i?"border-l-4":"border-l",i&&"shadow-md",L?"border-lyra-status-warning-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-warning-strong)_80%,black_20%)]":i?a==="critical"?"border-lyra-status-critical-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-critical-strong)_80%,black_20%)]":a==="warning"?"border-lyra-status-warning-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-warning-strong)_80%,black_20%)]":a==="success"?"border-lyra-status-success-strong hover:border-[color-mix(in_srgb,var(--lyra-color-status-success-strong)_80%,black_20%)]":"border-lyra-border-active hover:border-[color-mix(in_srgb,var(--lyra-color-border-active)_80%,black_20%)]":"border-lyra-border-subtle hover:border-lyra-border-soft");if(!re)return t.jsx(we,{open:G,onOpenChange:S,placement:"right",align:"start",sideOffset:8,showArrow:!1,onOpenAutoFocus:e=>e.preventDefault(),onCloseAutoFocus:e=>e.preventDefault(),onInteractOutside:e=>{var n,y;(y=(n=e.target)==null?void 0:n.closest)!=null&&y.call(n,"[data-radix-popper-content-wrapper]")&&e.preventDefault()},className:"z-[9999] w-64 rounded-lyra-sm border-0 bg-transparent p-0 shadow-none",bodyPadding:!1,content:t.jsx("div",{onMouseEnter:N,onMouseLeave:C,onFocus:N,onBlur:C,role:"button",tabIndex:0,onClick:p,onKeyDown:pe,ref:b,"aria-label":P,className:d(Z,!i&&"shadow-md"),children:Q}),children:t.jsxs("div",{ref:ie,role:"button",tabIndex:0,onClick:p,onKeyDown:he,onMouseEnter:N,onMouseLeave:C,onFocus:N,onBlur:C,"aria-label":P,"aria-current":i?"true":void 0,className:d("flex cursor-pointer flex-col items-center gap-1 rounded-lyra-sm p-1.5 mb-2 transition-colors","focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lyra-border-focus focus-visible:ring-offset-2",i?"bg-lyra-bg-surface-base shadow-sm":G&&"bg-lyra-state-hover",$),children:[t.jsxs("span",{className:"relative inline-flex",children:[t.jsx("span",{className:d("flex h-8 w-8 items-center justify-center rounded-lyra-sm border lyra-body-sm-emphasis",_.bg,_.text,_.border),"aria-hidden":"true",children:oe?se:t.jsx(ke,{className:"h-4 w-4",strokeWidth:1.5})}),c>1&&t.jsx("span",{className:d("absolute -left-1.5 -top-1.5 flex h-[18px] items-center justify-center rounded-full font-bold text-lyra-fg-on-primary",a==="critical"||a==="warning"?"w-[18px]":"min-w-[18px] px-1 text-[10px]",a==="critical"?"bg-lyra-bg-destructive":a==="warning"?"bg-lyra-status-warning-strong":a==="success"?"bg-lyra-status-success-strong":"bg-lyra-bg-primary"),"aria-label":a==="critical"?"SLA breached":a==="warning"?"Nearing SLA breach":`${c} open channels`,children:a==="critical"?t.jsx(Ne,{className:"h-2.5 w-2.5 shrink-0",strokeWidth:2.25,"aria-hidden":"true"}):a==="warning"?t.jsx(Ce,{className:"h-2.5 w-2.5 shrink-0",strokeWidth:2.25,"aria-hidden":"true"}):t.jsx("span",{"aria-hidden":"true",children:c})}),a&&t.jsx(B,{shape:"circle",dot:!0,variant:a,size:"sm",className:"absolute bottom-[-2px] right-[-2px] ring-2 ring-lyra-bg-surface-shell","aria-hidden":"true"})]}),T&&t.jsx("span",{className:d("lyra-body-xs",a==="critical"?"text-lyra-status-critical-strong":a==="warning"?"text-lyra-status-warning-strong":a==="success"?"text-lyra-status-success-strong":"text-lyra-fg-secondary"),"aria-hidden":"true",children:T})]})});const ee=()=>{v&&!l&&K(!0),p==null||p()};return t.jsx("div",{ref:x,role:"button",tabIndex:0,onClick:ee,onKeyDown:e=>D(e,ee),"aria-label":P,"aria-current":i?"true":void 0,className:d(Z,"mb-2",$),children:Q})});ne.displayName="InteractionNavItem";ne.__docgenInfo={description:"",methods:[],displayName:"InteractionNavItem",props:{customerName:{required:!1,tsType:{name:"string"},description:`Customer's full name — OR, for an interaction with no matched
